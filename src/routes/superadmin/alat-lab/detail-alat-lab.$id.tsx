...
export const Route = createFileRoute('/superadmin/alat-lab/detail-alat-lab/$id')({
...
function RouteComponent() {
    ...
    console.log('Detail alat lab with ID:', id);
    ...
    return (
        <StaffLayout>
            <main className='p-6 space-y-6 rounded-lg shadow-lg bg-base-200 shadow-base-content/5'>
                <h1 className='text-3xl font-bold'>Detail Data Alat Lab</h1>
                <p>Halaman untuk menampilkan data alat lab pada sistem.</p>

                <section className='grid gap-6 lg:grid-cols-2'>
                    <Fieldset className='w-full lg:col-span-2'>
                        <Fieldset.Legend>Nama Alat</Fieldset.Legend>
                    ...
                    <Fieldset className='w-full'>
                        <Fieldset.Legend>Jumlah Alat Tersedia</Fieldset.Legend>
                        <Fieldset.Body className='w-full input'>
                            <Icon icon='tabler:hash' />
                            <span>Jumlah Alat Tersedia</span>
                        </Fieldset.Body>
                    </Fieldset>

                    <Fieldset className='w-full'>
                        <Fieldset.Legend>Jumlah Alat</Fieldset.Legend>
                        <Fieldset.Body className='w-full input'>
                            <Icon icon='tabler:hash' />
                    ...
                    <Fieldset className='w-full lg:col-span-2'>
                        <Fieldset.Legend>Preview Alat</Fieldset.Legend>
                        <Fieldset.Body className='w-full input'>
                            <Icon icon='iconoir:eye' />
                            <span>Preview Alat</span>
                        </Fieldset.Body>
                    </Fieldset>
